...
extension UIView {
    @discardableResult
    public func setup(in superview: UIView, usingSafeLayout: Bool = true) -> Self {
    ...
    @discardableResult
    public func setup(centeredIn superview: UIView, usingSafeLayout: Bool = true) -> Self {
        return layout(in: superview) { make, its in
            if usingSafeLayout {
                make(its.centerXAnchor.constraint(equalTo: superview.safeAreaLayoutGuide.centerXAnchor))
                make(its.centerYAnchor.constraint(equalTo: superview.safeAreaLayoutGuide.centerYAnchor))
    ...
    @discardableResult
    public func setup(under view: UIView, in superview: UIView) -> Self {
        return layout(in: superview) { make, its in
    ...
    @discardableResult
    public func setup(matching view: UIView, in superview: UIView, inset: NSDirectionalEdgeInsets = .zero) -> Self {
        return layout(in: superview) { make, its in
    ...
    @discardableResult
    public func layout(in superview: UIView, setup: ((NSLayoutConstraint) -> Void, UIView) -> Void) -> Self {
